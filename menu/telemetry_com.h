#ifndef telemetry_com_h
#define telemetry_com_h
...
#define REQ_IN_SELECT_ID 5
#define CMD_IN_POLARITY_POS_ID 6
#define CMD_IN_POLARITY_NEG_ID 7
#define REQ_IN_POLARITY_ID 8
